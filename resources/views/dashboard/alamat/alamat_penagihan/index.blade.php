...
<div class="container mx-auto py-6">
    <div class="flex">
        ...
        <main class="w-3/4 bg-white p-6 border rounded shadow-md">
            <h2 class="text-2xl font-bold mb-6">Alamat Penagihan</h2>

            <div class="w-full">
                <form action="{{ isset($alamat) ? route('alamat-penagihan.update') : route('alamat-penagihan.store') }}" method="POST" class="w-full max-w-full mx-auto px-4 py-8 bg-white shadow-lg rounded-2xl border border-gray-100">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="no_hp" value="{{ old('no_hp', $alamat->no_hp ?? '') }}" class="w-full px-4 py-3 rounded-xl border @error('no_hp') border-red-500 @else border-gray-300 @enderror focus:ring-2 focus:ring-purple-500 focus:outline-none shadow-sm">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" name="email" value="{{ old('email', $alamat->email ?? '') }}" class="w-full px-4 py-3 rounded-xl border @error('email') border-red-500 @else border-gray-300 @enderror focus:ring-2 focus:ring-purple-500 focus:outline-none shadow-sm">
