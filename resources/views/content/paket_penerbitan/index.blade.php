...
<section class="container mx-auto bg-white text-[#1e1e1e] font-sans">
    <div class="flex justify-center gap-5 py-12">
      ...
      <div class="border rounded-lg shadow-sm p-6">
        ...
        <a href="{{ url('harga-paket/'.$ds->id) }}" class="mt-4 px-4 py-2 border border-gray-300 rounded-md text-sm font-medium hover:bg-gray-100">Lihat Paket</a>
        <hr class="my-6">
...
<section class="container mx-auto bg-white text-[#1e1e1e] font-sans">
  <div class="flex justify-center gap-5 py-12">
    ...
    <div class="border rounded-lg shadow-sm p-6 border">
        ...
        <a href="{{ url('harga-paket/'.$kb1->id) }}" class="mt-4 px-4 py-2 border border-gray-300 rounded-md text-sm font-medium hover:bg-gray-100">Lihat Paket</a>
        <hr class="my-6">
        <h4 class="text-sm font-semibold mb-3">Paket sudah termasuk:</h4>
        <ul class="space-y-2 text-sm text-gray-700">
          <li class="flex items-center"><span class="text-green-500 mr-2">✓</span> Review Naskah</li>
...
<section class="container mx-auto bg-white text-[#1e1e1e] font-sans">
  <div class="flex justify-center gap-5 py-12">
    ...
    <div class="border rounded-lg shadow-sm p-6 border">
        ...
        <a href="{{ url('harga-paket/'.$kb2->id) }}" class="mt-4 px-4 py-2 border border-gray-300 rounded-md text-sm font-medium hover:bg-gray-100">Lihat Paket</a>
        <hr class="my-6">
        <h4 class="text-sm font-semibold mb-3">Paket sudah termasuk:</h4>
        <ul class="space-y-2 text-sm text-gray-700">
          <li class="flex items-center"><span class="text-green-500 mr-2">✓</span> Review Naskah</li>
