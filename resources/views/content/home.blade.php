            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:p-2 mt-15">
                <div class="mt-12">
                    ...
                    <div class="flex justify-start space-x-4 mt-2">
                        <a target="_blank" href="{{ url('marketplace') }}" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700">Belanja Buku</a>
    ...
    <section class="mt-28 container mx-auto">
        <div class="grid grid-cols-2 mx-30">
           <div class=" pl-10">
               ...
               <p class="mt-2">Unpad Press berkomitmen untuk memberikan jasa layanan <br>
                penerbitan bagi sivitas maupun nonsivitas Unpad. Sebagai <br>
                penerbit perguruan tinggi, sejak tahun 2023, Unpad Press <br>
                ...
                <p>
                Selain itu, Unpad Press juga memberikan layanan penebitan <br>
                untuk karya fiksi bagi masyarakat umum guna menyebarkan <br>
                hasil olah pikir kreatif.
                </p>
                <p>
                    Berikut daftar layanan yang disediakan oleh Unpad Press:
                </p>
      ...
      <div class="grid grid-cols-2 mx-30">
        <div class="pl-15 pt-5">
          ...
          <h1 class="text-black text-4xl mt-4 font-bold">Berbagai pilihan jenis <br>
            pembayaran dan <br>
            pengiriman</h1>
          <p class="text-black font-bold mt-5 text-xl">Unpad Press kini didukung berbagai pilihan jenis <br>
